            ...
            <div className="pl-[350px] py-20 pr-20 flex flex-col gap-3 min-h-screen bg-gray-100">
                ...
                <Dialog open={open} onOpenChange={(val) => {
                    ...
                    <DialogContent className='sm:max-w[625px] max-h-[650px] overflow-y-scroll'>
                        ...
                        {editProduct && <div className="flex flex-col gap-2">
                                ...
                                {open && editProduct && (
                                    <div className="h-48 overflow-y-auto">
                                        <ReactQuill
                                            ...
                                            value={typeof editProduct.productDesc === 'string' ? editProduct.productDesc : ''}
                                            onChange={(value) => {
                                                const sanitized = sanitizeQuillHTML(value);
                                                setEditProduct(prev =>
                                                    prev.productDesc === sanitized ? prev : { ...prev, productDesc: sanitized }
                                                );
                                            }}
