        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white  shadow-md hover:shadow-lg transition duration-300 overflow-hidden">
              <img src="https://res.cloudinary.com/dxdywv9xl/image/upload/v1774253980/blog_1_zngocx.avif" alt="Blog Post 1" className="w-full h-48 object-cover" />
              <div className="p-6">
            ...
            {/* Blog Post Card 2 */}
            <div className="bg-white  shadow-md hover:shadow-lg transition duration-300 overflow-hidden">
              <img src="https://res.cloudinary.com/dxdywv9xl/image/upload/v1774254171/blog_2_p0i8s0.avif" alt="Blog Post 2" className="w-full h-48 object-cover" />
              <div className="p-6">
            ...
            {/* Blog Post Card 3 */}
            <div className="bg-white shadow-md hover:shadow-lg transition duration-300 overflow-hidden">
              <img src="https://res.cloudinary.com/dxdywv9xl/image/upload/v1774255308/blog_3_rhuwhp.avif" alt="Blog Post 3" className="w-full h-48 object-cover" />
              <div className="p-6">
